        ...
        <div className="min-h-screen bg-premium-dark flex flex-col items-center justify-start py-12 md:py-20 px-4 text-white">
            <div className="w-full max-w-[480px] relative z-10">
                ...
                <div className="text-center mb-8 relative z-10">
                    ...
                    <h1 className="text-4xl font-extrabold text-gray-100 tracking-tight">Create account</h1>
                    <p className="text-slate-400 mt-3 text-lg">Start chatting with everyone</p>
                </div>
                    ...
                    <div className="relative z-10 p-6">
                        <SignUp appearance={{
                            ...
                            elements: {
                                ...
                                socialButtonsBlockButton: "!bg-gray-600 !text-white hover:!bg-gray-900 border border-gray-300 shadow-md transition-all",
